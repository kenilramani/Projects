...
Follows the same agent-as-tool pattern as proceed_email and negotiation_engine.
"""
...
def dynamic_asset_sharing_instructions(context, agent) -> str:
    ...
    try:
        from app.prompts import asset_sharing_prompt
...
def create_asset_sharing_agent() -> Agent:
    """
    ...
    with users. Follows the same agent-as-tool pattern as proceed_email.
