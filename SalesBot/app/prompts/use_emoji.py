...
def use_emoji(state: BotState) -> str:
    ...
    if use_emoji == True:
      ...
      - Contextual Relevance: Use emojis that visually represent concrete objects or professional actions (e.g., 📅 for meetings, ✉️ for messages, 😀 or 😊 for casual uses or confirm demo).
      - Negative Constraints: 
        - NEVER use informal reaction emojis like 🤔, 🤨, 🙄, 🤫, 🤬, 👨‍👩‍👦, 👗, 🦝, 🎈 or 🤡.
        - Strictly avoid "thinking" or "puzzled" expressions.
      - Emojis are allowed ONLY in conversational, sales, or action responses, followup, demo booking.
