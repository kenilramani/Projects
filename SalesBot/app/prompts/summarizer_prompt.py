""""
This Flies has the PROMPTS used by summarizer agents in the system. 
"""
...
Integrate the latest conversation details into the existing summary. Preserve all key facts, user details, demo-related intents, and lead sentiment.
...
- ### Main Summary: A high-level overview with user details and essential highlights (Name, Email, Phone, Product, Demo Date & Time, Lead Sentiment, and 2–3 key takeaways).
...
SENTIMENT GUIDE
- hot → Shows clear buying intent, confirms demo, discusses features or pricing enthusiastically.
- warm → Shows curiosity or moderate interest without commitment.
- cold → Is disengaged, off-topic, or uninterested in the product/demo.
...
CONVERSATION SUMMARY EXPECTATIONS
