...
Usage:
    from app.config.constants import MAX_HISTORY, AgentName, BookingType
...
class AgentName(str, Enum):
    ...
    HUMAN = "human_agent"
    PROCEED_EMAIL = "switch_to_email_agent"
...
AGENT_HANDOFF_DESCRIPTIONS: Final[dict] = {
    ...
    AgentName.DEMO_BOOKING: (
        "Used for handling user's query when user wants to book a demo OR is "
        "providing booking details (email, timezone, date, time) for a demo. "
        "Hand off when user says 'book a demo', 'schedule a call', 'arrange a meeting', "
        "'reschedule', 'cancel demo', or responds to questions from this agent."
    ),
    AgentName.FOLLOWUP: (
