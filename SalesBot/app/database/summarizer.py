...
from app.core.state import UserContext, BotPersona, BotState, ContactDetails, Products
from app.route.route import router
import asyncio
from collections import deque
from typing import Optional, List, Tuple, Dict, Any

# from app.prompts.instruction import PromptTemplates
...
sessions = SummarizingSession(
    ...
    keep_last_n_turns=Settings().summarize_keep_last_n_turns,
    # context_limit=int(os.getenv("SUMMRIZE_CONTEXT_LENGTH", "3")),
    context_limit=Settings().summarize_context_length,
