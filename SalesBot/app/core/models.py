...
Usage:
    from app.core.models import BotState, UserContext, BotPersona
...
class NegotiationConfig(BaseModel):
    ...
    """
    max_discount_percent: float = Field(default=5.0, description="Maximum discount allowed")
...
class NegotiatedProduct(BaseModel):
    ...
    max_discount_percent: Optional[float] = Field(
        default=None, description="Maximum discount percent allowed for this product (system-managed)"
    )
...
class BotPersona(BaseModel):
    ...
    Attributes:
        ...
        proceed_email_details: Details for proceeding with email communication
    """
    ...
    current_cta: str = Field(default="", description="Current CTA")
...
class UserContext(BaseModel):
    ...
    Attributes:
        ...
        proceed_email_details: Email details
...
class BotResponse(BaseModel):
    ...
    def ensure_response_string(cls, v):
        ...
        from app.utils.utils import sanitize_response
