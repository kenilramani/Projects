...
@track
async def run_chatbot_api(state):
    ...
```
...
logger.info(f"[run_chatbot_api] user_id={user_id} agent={agent_name}")
...
*Production Features Checklist | BotRunner v2.0 | January 2026*
